    ...
    container.bind('sequelize').toConstantValue(async () => {
        ...
        sequelize = new Sequelize(
            ...
            password,
            {
               ...
               models: [TeamMarketOffer,Notification, TeamQueue, TeamMintPass, Post, GamePitchResult, GameHitResult, OffchainEvent, Season, Player, Team, Game, GameTeam, GamePlayer, Owner, Seed, League, User, Stadium, City, SignatureToken, TeamLeagueSeason, DiamondMintPass,
